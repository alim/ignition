    ...
    begin
      ...
      if groups.present?
        ...
        groups.each do |group|
          ...
          # Check to see if the requested resource is a Project class
          if self.to_s =~ /project/i
            ids += projects.pluck(:id) if projects.present?
          else # Just resource id's associated with each project
