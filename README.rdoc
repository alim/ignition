...
1. Edit the application.yml file to include an administrator login and email settings for your environments. The development one is shown, but you can add others for production and test.
    development:
...
1. Replace the secret token stored in the config/initializers/secret_token.rb file with the one generated from the _rake secret_ command.
