...
1. Add a mongoDB cartridge to your application
   rhc cartridge add -a yourapp -c mongodb-2.2
   
1. Add this upstream repository
   cd railsapp
...
1. Edit the application.yml file to include an administrator login and email settings for your environments. The development one is shown, but you can others for production and test.
   development:
