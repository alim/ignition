...
1. Create a rails application and check the results. You can name the application whatever you want. In the example, we use "someapp".
    rhc app create someapp ruby-1.9 mongodb-2.2 --from-code git@github.com:alim/ignition.git
...
1. Run the rhc command to install these environment variables for your application. You can then destroy the text file your created in the previous step.
